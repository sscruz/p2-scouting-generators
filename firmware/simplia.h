...
namespace shower_n_jets{
    ...
    struct helper{
        static void call( const Parton jets[njets], Parton out_particles[max_depth2*2*njets], const pt_t min_particle_energy, ap_uint<random_bits_per_splitting*(max_depth2*2-1)*njets> bigrand)
        {
