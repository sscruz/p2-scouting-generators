...
void bitpattern_pileup( PackedPuppiObj out_particles[n_pu_jets*pu_jet_npart],  ap_uint<10+8*n_pu_jets*pu_jet_npart+n_pu_jets*pu_jet_npart*10+random_bits_per_splitting*(pu_jet_depth2*2-1)*n_pu_jets+n_pu_jets*(lut_size+20)> bigrand);
